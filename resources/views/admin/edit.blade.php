...
<div class="container my-4">
    <div class="box-tabel">
        ...
        <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data" id="edit-project-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-group existing-files">
                ...
                @if($project->files->count() > 0)
                    <div class="mb-3">
                        <a href="{{ route('admin.projects.download', $project->id) }}" class="btn btn-success btn-sm" title="Download Semua File">
            ...
            <div class="tombol-aksi">
                <a href="{{ route('admin.index') }}" class="back-btn">Back</a>
