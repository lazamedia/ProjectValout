...
<body>
    ...
    <div class="popup-overlay" id="popupOverlay" onclick="hidePopup(event)">
        <div class="popup-content">
            ...
            <div class="info">
                <a href="https://wa.me/6281387584175"><i class="bi bi-whatsapp text-white"> Ketua</i></a>
                <a href="https://wa.me/6285713457076"><i class="bi bi-whatsapp text-white"> Humas</i></a>
